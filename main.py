...
async def handle_request(request: Request):
    ...
    #Extract the necessary information from the payload based on the structure of dialogeflow
    ...
    #     "fulfillmentText": "Sorry, I didn't understand your request. Can you try again?"
    #     })
...
def complete_order(parameters: dict, session_id: str):
    if session_id not in inprogress_orders:
        ...
        if order_id == -1:
            fulfillment_text = "Sorry, I couldn't process your order due to a backend error. plese place a new order again" 
                                # "plese place a new order again"
        
        else:
            order_total = db_helper.get_total_order_price(order_id)
            fulfillment_text =  f"Awsome. We have placed your order.Here is your order id # {order_id}.Your order total is {order_total} which you can pay at the time of dlivery!" 
                                # f"Here is your order id # {order_id}. " \
                                # f"Your order total is {order_total} which you can pay at the time of dlivery!"
